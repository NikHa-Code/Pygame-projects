...
# Line(surace, color, starting point, ending point, thickness)
pygame.draw.line(display_surface, RED, (0,0), (300, 0), 10)
pygame.draw.line(display_surface, GREEN, (0, 0), (0, 300), 10)
pygame.draw.line(display_surface, RED, (0,300), (300, 300), 10)
pygame.draw.line(display_surface, GREEN, (300, 300), (300, 0), 10)
...
# Rectangle (surface, color, (topleft x, top-left y, width, height))
